...
<a href="login.php" data-toggle="modal" data-target="#login-modal" class="btn navbar-btn btn-white pull-left"><i class="fa fa-sign-in"></i>Log in</a>
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="post-content margin-bottom--big">
              <p>Whether you are traveling from Asia to Europe or the other way around, the flight times can be intimidating and you will usually need to stop at an airport in between. So why not use your stop-over as a chance to see a city that, in itself, is very much worth visiting? Here are five exciting top stop-over spots:</p>
              <?php include('base.php');
        $q="select * from Travels where Continent='Eurasia'";
        $res= $conn->query($q);
    ...
    <section class="background-gray-lightest section--padding-bottom-small">
      <div class="container">
        ...
        <div class="row">
          <?php include('base.php');
          $q="SELECT * FROM `travels` WHERE TravelID='15' OR TravelID='14' OR TravelID='13'";
          $res= $conn->query($q);
          while($rec= mysqli_fetch_assoc($res)){
